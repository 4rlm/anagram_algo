...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Simple algorithm to find and return list of anagrams from your text input}
  spec.description   = %q{Simple algorithm to find and return list of anagrams from your text input.}

  spec.homepage      = 'https://github.com/4rlm/anagram_algo'
  spec.license       = "MIT"
